...
class BarcodeResult {
  ...
  factory BarcodeResult.fromMap(Map<String, dynamic> map) {
    String format = map['format'] as String;
    String text = map['text'] as String;
    int x1 = map['x1'] as int;
    int y1 = map['y1'] as int;
    int x2 = map['x2'] as int;
    int y2 = map['y2'] as int;
    int x3 = map['x3'] as int;
    int y3 = map['y3'] as int;
    int x4 = map['x4'] as int;
    int y4 = map['y4'] as int;
    int angle = map['angle'] as int;

    List<int> barcodeBytes = (map['barcodeBytes'] as List).cast<int>();
    Uint8List barcodeBytesUint8List = Uint8List.fromList(barcodeBytes);
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'y4': y4,
      'angle': angle,
      'barcodeBytes': barcodeBytes.toList(), // Chuyển Uint8List thành List<int>
    };
  }
